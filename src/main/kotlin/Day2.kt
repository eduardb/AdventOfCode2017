fun main(args: Array<String>) {
    val input = """1136	1129	184	452	788	1215	355	1109	224	1358	1278	176	1302	186	128	1148
...
6151	5857	4865	437	6210	237	37	410	544	214	233	6532	2114	207	5643	6852"""
    println(Day2a.solveFor(input))
    println(Day2b.solveFor(input))
}
        ...
        return input.split('\n')
                .sumBy {
                    val numbers = it.split(DELIMITER)
                            .map { it.toInt() }
                    return@sumBy numbers.max()!! - numbers.min()!!
                }
    }
